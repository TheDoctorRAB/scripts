...
########################################################################
# 
# Searches each of the burnup data and finds the keff and associated burnup closest to critical greater than 1.00
...
#
content_burnup_file=open('burnup.content_upper.out','a')
#
#######
#
# search the file
...
for i in range(0,time_steps-1):
    if mcnpx_file[i,4]>1 and (mcnpx_file[i+1,4]<1):
        content_burnup_file.write('\t'+str.format('%.3e'%mcnpx_file[i,8])+'\t'+str.format('%.5f'%mcnpx_file[i,4])+'\n')
# end i 
#
#######
# 
