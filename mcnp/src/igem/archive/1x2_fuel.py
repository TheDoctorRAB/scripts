...
while (cel<94): #up to 111 
    #first layer of cylinders
    print(cel, mat3, -dens3, -cyl,  401, -402, 'imp:n=1'  )
    print(cel+1, mat4, -dens3, cyl, -cyl -1, 401, -402, 'imp:n=1'  )
    print(cel+2, mat3, -dens3, -cyl - 2,  401, -402, 'imp:n=1'  )
    print(cel+3, mat4, -dens3, cyl + 2, -cyl -3, 401, -402, 'imp:n=1'  )
    print('c')
    #second layer of cylinders
    print(cel+4, mat3, -dens3, -cyl - 20,  401, -402, 'imp:n=1'  )
    print(cel+5, mat4, -dens3, cyl + 20, -cyl -21, 401, -402, 'imp:n=1'  )
    print(cel+6, mat3, -dens3, -cyl - 22,  401, -402, 'imp:n=1'  )
    print(cel+7, mat4, -dens3, cyl + 22, -cyl -23, 401, -402, 'imp:n=1'  )
    print('c')
    cel = cel + 8
    cyl = cyl + 4
print('c')    
...
while (cel<127): 
    ...
    print('c')
    print(cel+4, mat3, -dens3, -tor - 4,  402, 'imp:n=1'  )
    print(cel+5, mat4, -dens3, tor + 4, - tor -5, 402, 'imp:n=1'  )
    print(cel+6, mat3, -dens3, -tor - 6,  402, 'imp:n=1'  )
    print(cel+7, mat4, -dens3, tor + 6, - tor -7, 402, 'imp:n=1'  )
    print('c')
    cel = cel + 8
    tor = tor + 10
...
while (cel<151): #  
    print(cel, ' ', mat1,' ', -dens3,' ', sury1,' ', -sury1 -3,' ', 4,' ', -2,' ',  401,' ', -403,' ', '\n',
          '     ', "#", cyl, ' ', "#",cyl+1,' ', "#",cyl+6, ' ', "#",cyl+7,' ', "#",cyl+12,' ', "#",cyl+13,' ', "#",cyl+18,' ', "#", cyl+19,' ','\n',
...
while (cel<158): 
    ...
    cel = cel + 1  
    tor = tor + 4  
    print(cel, ' ', mat1,' ', -dens3,' ', surx1,' ', -surx1 -3,' ', 15,' ', -13,' ',  401,' ', -403,' ', '\n',
          '     ', "#", cyl,' ', "#",cyl+1,' ', "#",cyl+8,' ', "#",cyl+9,' ', "#",cyl+16,' ', "#",cyl+17,' ', "#",cyl+24,' ', "#", cyl+25,' ','\n',
          '     ', "#", tor, ' ', "#",tor+1,' ', "#",tor+2, ' ',"#",tor+3, ' ','\n',
          '     ', 'imp:n=1', sep ='')
    print('c')
...
print( cel, mat1, -dens1, 1, -5, 11, -16, 403, -404, 'imp:n=1'  )
cel = cel + 1
print( cel, mat1, -dens1, 1, -5, 11, -16, 400, -401, 'imp:n=1'  )
cel = cel + 1
print( cel, mat5, -dens5, '-1:5:-11:16:-400:404',  'imp:n=1'  )
'''
End code to generate fuel array cells
'''
