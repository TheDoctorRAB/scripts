...
#
####### prepare output file
scale_output_file=os.path.splitext(scale_output)[0]+'_mass.fission.products.out'
#######
#
...
for line in scale_file:
    if line.strip() == "=   Nuclide concentrations in grams, fission products for case 'decay' (#2/2)                                           =":
        extract = True
    elif line.strip() == "=========================================================================================================================":
        extract = False
    elif extract:
