...
#
####### prepare output file
scale_output_file=os.path.splitext(scale_output)[0]+'_spontaneous.fission.out'
#######
#
...
for line in scale_file:
    if line.strip() == "=   Spontaneous fission neutron source, neutrons/sec for case 'decay' (#2/2)                                            =":
        extract = True
    elif line.strip() == "=========================================================================================================================":
        extract = False
    elif extract:
